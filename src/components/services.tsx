  ...
  return (
    ...
    <div className="container px-5 mx-auto">
      <div className="text-center mb-20">
        <h1  id="services" className="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">
        Our Services
        </h1>
      ...
      <div className="  flex  flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
        {/* Free delivery*/}
        <div className="group p-4 lg:w-1/3 flex justify-center flex-col text-center items-center">
        ...
        <div className="group p-4 lg:w-1/3 flex justify-center flex-col text-center items-center">
          <div className="w-20 h-20 inline-flex items-center justify-center  rounded-full bg-indigo-100 text-indigo-500 mb-5 flex-shrink-0">
          <Image alt='hony'  width={55} height={55} color='blue' src={require("../../public/pic/hony1.png")} />
          </div>
          <div className="flex-grow">
            <h2 className="text-gray-900 group-hover:text-orange-300 duration-300 text-lg capitalize title-font font-medium mb-3">
            24/7 services
